    ...
    <body>
        <?php if ($user) { ?>
            ...
            <div class="d-flex justify-content-center align-items-center vh-100">
                ...
                <form class="shadow w-450 p-3" action="php/delete.php" method="post" enctype="multipart/form-data">

                    <h4 class="display-4  fs-1">Delete cursus</h4><br>
                    <!-- error -->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="text" value="<?php echo $user['text'] ?>">
                    </div>
